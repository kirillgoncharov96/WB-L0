...
var Data = [{
  ...
  legalEntity: 'OOO Вайлдберриз',
  tooltip: {
    tooltipTitle: 'OOO «ВАЙЛДБЕРРИЗ»',
    tooltipText: 'ОГРН: 1067746062449',
    tooltipAdress: '142181, Московская область, д Коледино, тер. Индустриальный Парк Коледино, д. 6 стр. 1'
  },
  quantityMin: 1,
  quantityStart: 1,
  remainingGoods: 2,
  ...
  location: 'Коледино WB',
  legalEntity: 'OOO Мегапрофстиль',
  tooltip: {
    tooltipTitle: 'OOO «МЕГАПРОФСТИЛЬ»',
    tooltipText: 'ОГРН: 5167746237148',
    tooltipAdress: '129337, Москва, улица Красная Сосна, 2, корпус 1, стр. 1, помещение 2, офис 34'
  },
  quantityMin: 1,
  quantityStart: 200,
  price: 11500,
...
/***/ "./src/js/modules/closeCardGoods.js":
/*!******************************************!*\
  !*** ./src/js/modules/closeCardGoods.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
var closeCardGoods = function closeCardGoods() {
  // Первая карточка
  var btnTriggerClose = document.querySelector('.card-1__arrow'),
    btnTriggerOpen = document.querySelector('.card-1__arrow__close');
  btnTriggerClose.addEventListener('click', function () {
  ...
  btnTriggerOpen.addEventListener('click', function () {
  ...
  //Вторая карточка 
  var btnTrigger = document.querySelector('.card-2__arrow');
...
/* harmony default export */ __webpack_exports__["default"] = (closeCardGoods);
...
/* harmony import */ var _formatValue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./formatValue */ "./src/js/modules/formatValue.js");
...
var formValidation = function formValidation() {
  ...
  function validateForm(form) {
    ...
    var isAnyInputInvalid = inputs.map(validateInput).some(function (validation) {
      return !validation;
    });
    var isAnyInputEmpty = inputs.map(isInputEmpty).some(function (validation) {
      return validation;
    });
    var invalidInputs = form.querySelectorAll('label.invalid input');
  ...
  function validateInput(input) {
    ...
    var warningBlock = label.querySelector('.input-block__warning');
    var inputValue = input.value;
    var validationConditions = {
      'name': {
        antiPattern: /[^a-zA-Zа-яА-ЯёЁ]/,
        isValid: function isValid(value) {
          return value === '' || !validationConditions['name'].antiPattern.test(value);
        }
      },
      'surname': {
        antiPattern: /[^a-zA-Zа-яА-ЯёЁ]/,
        isValid: function isValid(value) {
          return value === '' || !validationConditions['surname'].antiPattern.test(value);
        }
      },
      'email': {
        pattern: /^[\w-]+(\.[\w-]+)*@[\w-]+(\.[\w-]+)+$/,
        isValid: function isValid(value) {
          return value === '' || validationConditions['email'].pattern.test(value);
        }
      },
      'tel': {
        pattern: /^\+\d\s\d{3}\s\d{3}\s\d{2}\s\d{2}$/,
        isValid: function isValid(value) {
          return value === '' || validationConditions['tel'].pattern.test(value);
        }
      },
      'itn': {
        isValid: function isValid(value) {
    ...
    var isInputValid = (_validationConditions = validationConditions[inputID]) === null || _validationConditions === void 0 ? void 0 : _validationConditions.isValid(inputValue);
    if (!isInputValid) {
      markAsInvalid(label);
  ...
  function isInputEmpty(input) {
    var isEmpty = input.validity.valueMissing;
    if (isEmpty) {
      var inputID = input.id;
      var label = input.closest('label');
      var warningBlock = label.querySelector('.input-block__warning');
  ...
  formInputs.querySelectorAll('input').forEach(function (input) {
    ...
    if (input.id === 'tel') {
      input.addEventListener('input', function () {
        return handleTelInputChange(input);
      });
    }
  });
  ...
  function handleOrderSubmit(event, formToValidate) {
    ...
    var inputs = formToValidate.querySelectorAll('input');
  ...
  orderForm.addEventListener('click', function (event) {
    return handleOrderSubmit(event, formInputs);
  });

  //Отображение цены при клике на checkbox (оплата сразу)
  var checkboxPayMethod = document.querySelector('.checkbox.select-paymethod'),
  ...
  checkboxPayMethod.addEventListener('click', function () {
    if (checkboxPayMethod.classList.contains('checkbox_active')) {
      ...
      submitBtn.textContent = "\u041E\u043F\u043B\u0430\u0442\u0438\u0442\u044C ".concat((0,_formatValue__WEBPACK_IMPORTED_MODULE_8__["default"])(priceValue.textContent), " \u0441\u043E\u043C");
...
/* harmony default export */ __webpack_exports__["default"] = (formatValue);
...
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/es.symbol.description.js */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _data_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../data/data */ "./src/js/data/data.js");





var showGoods = function showGoods() {
  _data_data__WEBPACK_IMPORTED_MODULE_4__.Data.map(function (item) {
  ...
  _data_data__WEBPACK_IMPORTED_MODULE_4__.Data.map(function (item) {
    var cardMiss = document.createElement("div");
    if (item.id === 1) {
      cardMiss.classList.add("product__card__absent", "item-".concat(item.id));
      cardMiss.innerHTML = "\n                <div class=\"item-".concat(item.id, "__details\">\n                    <div class=\"item-").concat(item.id, "__details__img\">\n                        <img\n                            src=").concat(item.img, "\n                            alt=\"\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435 \u0442\u043E\u0432\u0430\u0440\u0430 \u0444\u0443\u0442\u0431\u043E\u043B\u043A\u0430\"\n                        />\n                        <div\n                            class=\"item-").concat(item.id, "__details__img-prop\"\n                        >\n                            56\n                        </div>\n                    </div>\n                    <div class=\"product__card__info\">\n                        <h6 class=\"product__card__title\">\n                            ").concat(item.title, "\n                        </h6>\n                        <div\n                            class=\"product__card__description\"\n                        >\n                            <p\n                                class=\"product__card__description-text\"\n                            >\n                                ").concat(item.description.color, "\n                            </p>\n                            <p\n                                class=\"product__card__description-text\"\n                            >\n                                ").concat(item.description.size, "\n                            </p>\n                        </div>\n                    </div>\n                    <div\n                        class=\"product__card__quantity-goods\"\n                    >\n                        <div\n                            class=\"product__card__quantity-goods__icons control-buttons\"\n                        >\n                            <button\n                                class=\"control-buttons__favorite\"\n                                type=\"button\"\n                            ></button>\n                            <button\n                                class=\"control-buttons__delete\"\n                                type=\"button\"\n                            ></button>\n                        </div>\n                    </div>\n                </div>\n            ");
    } else if (item.id === 2) {
      cardMiss.classList.add("product__card__absent", "item-".concat(item.id));
      cardMiss.innerHTML = "\n                <div class=\"item-".concat(item.id, "__details\">\n                    <div class=\"item-").concat(item.id, "__details__img\">\n                        <img\n                            src=").concat(item.img, "\n                            alt=\"\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435 \u0442\u043E\u0432\u0430\u0440\u0430 \u0444\u0443\u0442\u0431\u043E\u043B\u043A\u0430\"\n                        />\n                    </div>\n                    <div class=\"product__card__info\">\n                        <h6 class=\"product__card__title\">\n                            ").concat(item.title, "\n                        </h6>\n                        <div\n                            class=\"product__card__description\"\n                        >\n                            <p\n                                class=\"product__card__description-text\"\n                            >\n                                ").concat(item.description.color, "\n                            </p>\n                        </div>\n                    </div>\n                    <div\n                        class=\"product__card__quantity-goods\"\n                    >\n                        <div\n                            class=\"product__card__quantity-goods__icons control-buttons\"\n                        >\n                            <button\n                                class=\"control-buttons__favorite\"\n                                type=\"button\"\n                            ></button>\n                            <button\n                                class=\"control-buttons__delete\"\n                                type=\"button\"\n                            ></button>\n                        </div>\n                    </div>\n                </div>\n            ");
...
/* harmony default export */ __webpack_exports__["default"] = (showGoods);

/***/ }),

/***/ "./src/js/modules/сhooseGoods.js":
/*!***************************************!*\
  !*** ./src/js/modules/сhooseGoods.js ***!
  \***************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var chooseGoods = function chooseGoods() {
  ...
  var btnCheckBoxAll = document.querySelector('.checkbox'),
  ...
  ;
  btnCheckBoxAll.addEventListener('click', function () {
    if (btnCheckBoxAll.classList.contains('checkbox_active')) {
      btnCheckBoxAll.classList.remove('checkbox_active');
      btnCheckBoxAllGoods.forEach(function (item) {
  ...
  btnCheckBoxAllGoods.forEach(function (item, index) {
    item.addEventListener('click', function () {
  ...
  function disabledButtons(input) {
    var currentValue = parseInt(input.closest('.selector__counter').querySelector('.selector__counter-number').value);
    if (currentValue === 1) {
  ...
  ;
  btnPlusValue.forEach(function (btn, index) {
  ...
  btnMinusValue.forEach(function (btn, index) {
    btn.addEventListener('click', function () {
      btn.closest('.selector__counter').querySelector('.selector__counter-number').value--;
      disabledButtons(btn);
      disabledButtonsPlus(btn, index);
  ...
  function quantityOfGoods() {
    var sum = 0;
    inputsValue.forEach(function (item, index) {
  ...
  function productShow(value) {
    ...
    if (first >= 11 && first <= 19) {
      ...
      document.querySelector('.card-1__text.card-1__text__close').children[0].textContent = "".concat(value, " \u0442\u043E\u0432\u0430\u0440\u043E\u0432 \xB7");
    } else if (second >= 2 && second <= 4) {
      document.querySelector('.value__text').textContent = 'товара';
      document.querySelector('.card-1__text.card-1__text__close').children[0].textContent = "".concat(value, " \u0442\u043E\u0432\u0430\u0440\u0430 \xB7");
    } else if (second === 1) {
      document.querySelector('.value__text').textContent = 'товар';
      document.querySelector('.card-1__text.card-1__text__close').children[0].textContent = "".concat(value, " \u0442\u043E\u0432\u0430\u0440 \xB7");
    } else {
      document.querySelector('.value__text').textContent = 'товаров';
      document.querySelector('.card-1__text.card-1__text__close').children[0].textContent = "".concat(value, " \u0442\u043E\u0432\u0430\u0440\u043E\u0432 \xB7");
    }
  ...
  function deliveryShow(value) {
    ...
    basketMobileValue.textContent = "".concat(value);
    ...
    checkboxActive.forEach(function (item, index) {
      if (item.classList.contains('checkbox_active')) {
        document.querySelector(".product-card__photo-".concat(index + 1)).style.display = 'block';
      } else {
...
/* harmony import */ var _modules_formValidation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/formValidation */ "./src/js/modules/formValidation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_formValidation__WEBPACK_IMPORTED_MODULE_7__["default"])();

  //Активация heart
  var btnsHeart = document.querySelectorAll('.control-buttons__favorite');
  btnsHeart.forEach(function (item) {
    item.addEventListener('click', function () {
  ...
  var btnsDelete = document.querySelectorAll('.main__basket__product__absent .control-buttons__delete'),
    cardText = document.querySelector('.card-2__text');
  btnsDelete.forEach(function (item) {
    item.addEventListener('click', function (e) {
      var productElement = e.target.closest('.product__card__absent');
      document.querySelector('.main__basket__product__absent').style.paddingTop = '10px';
      var remainingGoods = document.querySelectorAll('.product__card__absent').length - 1;
      if (remainingGoods === 2) {
        cardText.textContent = "\u041E\u0442\u0441\u0443\u0442\u0441\u0442\u0432\u0443\u044E\u0442 \xB7 ".concat(remainingGoods, " \u0442\u043E\u0432\u0430\u0440\u0430");
      } else if (remainingGoods === 1) {
        cardText.textContent = "\u041E\u0442\u0441\u0443\u0442\u0441\u0442\u0432\u0443\u0435\u0442 \xB7 ".concat(remainingGoods, " \u0442\u043E\u0432\u0430\u0440");
      } else {
